...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\AgendamentoPacote>
 */
class AgendamentoPacoteFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        $dataMinimaCancelamento = fake()->randomElement([
            fake()->dateTimeInInterval($dataHora, '-1 day'),
            null,
        ]);
        ...
        return [
            'data_hora' => $dataHora,
            'data_minima_cancelamento' => $dataMinimaCancelamento,
            'duracao' => $duracao,
            'status' => $status,
