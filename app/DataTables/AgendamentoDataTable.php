...
class AgendamentoDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($row) {
                $editarButton = '<button title="Editar" class="btn" style="margin-right: 5px;"><a href="' . route('agendamentos.edit', ['agendamento' => $row->id]) . '"><i class="fas fa-edit"></i></a></button>';
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('servico.nome')->title('Serviço'),
